 const questionsObjs = [{
   ...
   optionTwo: true
    ...
    id: 3,
   question: '¿ Existe alguna diferencia entre un "componente" y un "elemento" ?',
   text:'',
   option: true,
   optionTwo: false
},{
   ...
   optionTwo: true
    ...
    id: 5,
   question: '¿ React Native esta mas orientada al desarrollo de apps para movil ?',
   ...
   optionTwo: false
    ...
    id: 7,
   question: ' En un button ¿ Es lo mismo escribir onclick=\'funcionUno()\' que onClick={funcionUno()}?',
   text:'',
   option: false,
   optionTwo: true
},{
